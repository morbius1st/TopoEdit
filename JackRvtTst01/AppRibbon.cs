...
namespace JackRvtTst01
{
	internal class AppRibbon : IExternalApplication
	{
		...
		// internal static AppRibbon thisApp = null;
		// private MainWindow mainWin;
		private Window revitWindow;

		private const string NAMESPACE_PREFIX = "JackRvtTst01.Assets";

		private const string PANEL_NAME = "JackRvtTst01";
		private const string TAB_NAME = "AO Tools";

		private const string BUTTON_NAME = "JackRvtTst01";
		private const string BUTTON_TEXT = "JackRvtTst01";
		...
		private const string CLASSPATH = "JackRvtTst01.";
		...
		// 		ExternalEvent eEvent = ExternalEvent.Create(handler);
		//
		// 		mainWin = new MainWindow(eEvent, handler);
		// 		mainWin.Owner = RevitLibrary.RvtLibrary.WindowHandle(uiApp.MainWindowHandle);
		//
		// 		mainWin.Show();
		// 	}
		// }
